...
$PageOptions['ContactEmail']                         = 'bg5hhp@hamclub.net';		    // Support E-Mail address
...
$CallingHome['Country']                              = "CN";                         // Country
...
$CallingHome['InterlinkFile']                        = "/etc/mmdvm/xlxd/xlxd.interlink";                 // Path to interlink file
